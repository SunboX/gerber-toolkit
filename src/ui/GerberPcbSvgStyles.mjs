...
export class GerberPcbSvgStyles {
    ...
    static render() {
        return [
            ...
            '.pcb-copper--surface .pcb-copper--mask-covered.gerber-region,.pcb-copper--surface .pcb-copper--mask-covered .gerber-macro-region{fill:var(--pcb-mask-covered-fill,rgba(42,95,39,.34));stroke:none;opacity:1;}',
